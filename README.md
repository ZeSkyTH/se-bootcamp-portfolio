...
ผมสนใจเรียนวิศวกรรมซอฟต์แวร์ เพราะชอบการแก้ปัญหาด้วยเทคโนโลยี และต้องการพัฒนาทักษะการเขียนโปรแกรมเพื่อสร้างเว็บไซต์ แอปพลิเคชัน และระบบที่สามารถใช้งานได้จริงในอนาคต
---
...
- ให้ช่วย gen รูปภาพให้ใส่สูทผูกเนคไท
- ให้ช่วย gen infographic 
- ช่วยตรวจและจัดรูปแบบ README.md

### Prompt ที่ฉันใช้
```
ให้ทำ infographic แนวนอน รายละเอียดให้คนในภาพ ชื่อ นายวิทวัส มะมะแอ
จบมาจากวิทยุเทคนิคอุตรดิตถ์
สนใจเกี่ยว Programming, Database, Develop, graphics
Email bank37118@gmail.com
Tel. 0842964844
ช่วยอธิบาย Flowgorithm และ Loop พร้อมตัวอย่าง
ช่วยจัดรูปแบบ README.md ให้ดูเป็น portfolio

```

### ฉันตรวจสอบคำตอบของ AI อย่างไร
- เปรียบเทียบกับเนื้อหาที่เรียนในห้อง
- ทดลองทำแบบฝึกหัดด้วยตนเอง
- ตรวจสอบผลลัพธ์จากการรันโปรแกรม

### สิ่งที่ฉันยังต้องเรียนรู้เอง
- การเขียนโปรแกรมให้ซับซ้อนขึ้น
- การออกแบบอัลกอริทึม
- การใช้ Git และ GitHub ให้คล่อง
...
- ใช้ Flowgorithm และ Git ได้อย่างถูกต้อง

### เป้าหมายใน 1 เดือนแรก
- เขียนโปรแกรมขนาดเล็กได้ด้วยตนเอง
- ใช้ GitHub ในการจัดเก็บผลงาน
- สร้าง Portfolio ที่สามารถนำเสนอได้
...
- การคิดอย่างเป็นลำดับขั้นตอนและการแก้ปัญหาอย่างมีเหตุผล

### เรื่องที่ยังไม่เข้าใจ
- การใช้ Loop และเงื่อนไขที่ซับซ้อนในบางสถานการณ์

### สิ่งที่ฉันจะฝึกต่อ
- เขียนโปรแกรมทุกวัน
- ฝึกทำโจทย์ Algorithm
- ศึกษา Git, GitHub และภาษาโปรแกรมเพิ่มเติม
